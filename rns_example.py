...
def announceLoop(destination_1, destination_2):
    ...
    while True:
        ...
        #     " ("+destination_1.name+")"
        # )
        print(f"SND Node {RNS.prettyhexrep(destination_1.hash)}: {fruit}")
        ...
        #     " ("+destination_2.name+")"
        # )
        print(f"SND Node {RNS.prettyhexrep(destination_2.hash)}: {noble_gas}")
...
class ExampleAnnounceHandler:
    ...
    def received_announce(self, destination_hash, announced_identity, app_data):
        ...
        if app_data:
            print(f"RCV Node {RNS.prettyhexrep(announced_identity.hash)}: {app_data.decode('utf-8')}")
            # RNS.log(
